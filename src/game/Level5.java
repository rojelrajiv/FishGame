...
public class Level5 extends GameLevel {
    ...
    public void populate(Game game) {
        ...
        }
        {
            ...
            platform2.setPosition(new Vec2(18, 3.0f));
...

        {
            ...
            platform7.setPosition(new Vec2(10, -6f));
        ...
        }
        {
            ...
            shark.setPosition(new Vec2(2 - 10, (float) Math.random() * 20.0f - 10.0f));
            shark.addCollisionListener(new Pickup(getPlayer()));
            shark.startWalking(2);
        }

        {
            Shark shark2 = new Shark(this);
            shark2.setPosition(new Vec2(2 - 10, (float) Math.random() * 20.0f - 10.0f));
            shark2.addCollisionListener(new Pickup(getPlayer()));
            shark2.startWalking(2);
        }
