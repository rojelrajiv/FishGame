 ...
 * @author Rojel
 */
public class Level3P2 extends GameLevel2 {
     ...
     * @param game2
     */
    public void populate(Game2 game2) {
        super.populate(game2);
        ...
        {
            CyanPlatform cp2 = new CyanPlatform(this);
        ...
        }
        {
            ...
            rp2.addCollisionListener(new Pickup2(getPlayer2()));
                    ...
                    JOptionPane.showMessageDialog(null, "Ready? Press okay to start level. ", "Level 3", JOptionPane.INFORMATION_MESSAGE);
